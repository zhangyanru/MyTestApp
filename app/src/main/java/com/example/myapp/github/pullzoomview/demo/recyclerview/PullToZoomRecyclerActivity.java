package com.example.myapp.github.pullzoomview.demo.recyclerview;
...
import com.example.myapp.github.pullzoomview.demo.PullToZoomRecyclerViewEx;
...
public class PullToZoomRecyclerActivity extends ActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.pull_zoom_viewlist_view, menu);
        return true;
    }
